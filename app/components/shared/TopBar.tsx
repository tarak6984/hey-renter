 ...
 * Figma specs: bg=#12151C, height=40px, padding=8px 39px
 * Social icons: 24×24, gap=8px, white → lime #B8F04F on hover
 * Right: EN | UAE Dirham (AED) | 🇦🇪 Dubai — gap=3px, font=TT Norms Pro 16px fw=500
 * Dividers: 1.5×15px white rgba(255,255,255,0.10)
...
export default function TopBar() {
  return (
    ...
    >
      ...
      {/* Hover style injected via global CSS for social icons */}
      <style>{`
...
/** Subtle vertical divider – white at 10% opacity, 1.5×15px */
...
/** UAE flag as circular SVG – matches Figma's circular flag design */
function UAEFlag() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
      ...
      {/* Black horizontal stripe (middle) */}
