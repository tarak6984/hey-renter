...
export default function CarCard({ car }: CarCardProps) {
  ...
  return (
    ...
    >
      <div className="relative h-[220px] flex-shrink-0 overflow-hidden rounded-[10px]">
        <Image
          src={car.images[0]}
        ...
        {car.noDeposit ? (
          ...
          >
            <span className="text-sm font-medium leading-none text-white">No Deposit</span>
          </div>
        ) : null}
      ...
      <div className="flex items-center justify-between px-2" style={{ gap: 17 }}>
        <div className="flex flex-col" style={{ gap: 8 }}>
          ...
          <div className="flex items-end">
            ...
            <span
              style={{ fontSize: 14, fontWeight: 400, color: 'rgba(0,0,0,0.5)', marginLeft: 2 }}
            >
              /day
            </span>
          </div>
        ...
        <div className="flex flex-wrap items-center" style={{ gap: 8 }}>
          <a
            ...
            aria-label="WhatsApp"
            className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-[40px]"
          ...
          <Link
            href={`/cars/${car.slug}`}
            className="flex h-14 items-center justify-center whitespace-nowrap rounded-[100px] border-2 border-[#B8F04F] bg-[#12151C] px-4 font-bold text-white"
            style={{
              fontSize: 16,
              fontWeight: 700,
