...
export const CAR_CATEGORIES: {
  ...
  { id: 'super',          label: 'SUPER',          carCount: 150, fromPrice: 1200, image: '/assets/cars/listings/ferrari-1.webp', gradient: 'linear-gradient(0deg, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0) 37%), linear-gradient(135deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.4) 35%, rgba(0,0,0,0) 100%)' },
