    ...
    <div style={{ background: '#F5F5F5', minHeight: '100vh' }}>
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 pb-16 sm:px-6 md:px-[39px]">
        <div className="mx-auto max-w-[666px]">
          <div className="flex flex-col gap-8 rounded-[20px] border border-black/10 bg-white px-4 pb-4 pt-8 sm:gap-10 sm:px-6 sm:pb-6 sm:pt-10">
            <div className="flex flex-col items-center gap-6">
              <div className="flex flex-wrap items-center justify-center gap-3 rounded-full border border-black/10 bg-black/[0.06] px-6 py-4">
                ...
                <h1 className="m-0 text-center text-[24px] font-bold leading-8 text-black sm:text-[30px] sm:leading-[38px]">
                  Booking Confirmed
                </h1>
              </div>

              <div className="flex flex-wrap items-center justify-center gap-3 text-center">
                <span className="text-[16px] font-medium leading-6 text-black/50 sm:text-[18px] sm:leading-[26px]">
                  Booking ID: <span className="font-bold text-black">{bookingId}</span>
                </span>
                <button
                  onClick={handleCopy}
                  className="bg-transparent p-0 text-[16px] font-medium leading-6 text-[#0052FF] transition-opacity hover:opacity-80 sm:text-[18px] sm:leading-[26px]"
                >
            ...
            <div className="flex flex-col items-center gap-7">
                <h2 className="m-0 text-center text-[24px] font-bold leading-8 text-black sm:text-[30px] sm:leading-[38px]">
                  Want to move faster?
                </h2>
              ...
              <a
                ...
                className="flex min-h-14 w-full items-center justify-center gap-3 rounded-[10px] bg-[#1CC25A] px-4 py-3 text-center no-underline transition-colors hover:bg-[#18b253] sm:px-6"
              >
                <span className="text-[16px] font-medium leading-6 text-white sm:text-[18px] sm:leading-[26px]">
                  Contact us on
                </span>
                ...
                <span className="text-[16px] font-medium leading-6 text-white sm:text-[18px] sm:leading-[26px]">Whatsapp</span>
              </a>
            </div>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col items-center gap-2 text-center">
                <h2 className="m-0 text-[24px] font-bold leading-8 text-black sm:text-[30px] sm:leading-[38px]">
                  Upload Your Documents
                </h2>
                <p className="m-0 text-[16px] font-normal leading-6 text-black sm:text-[18px] sm:leading-[26px]">
...
function UploadField({
  ...
  return (
    <div className="flex flex-col gap-5 rounded-[20px] border border-black/10 bg-black/[0.02] px-4 py-5 sm:px-6 sm:py-6 md:flex-row md:items-center md:justify-between">
      <div className="flex flex-col gap-2">
        <p className="m-0 text-[20px] font-medium leading-7 text-black sm:text-[24px] sm:leading-8">
          {title}
        </p>
        <p className="m-0 text-[16px] font-normal leading-6 text-black sm:text-[18px] sm:leading-[26px]">
          {body}
      ...
      <label className="cursor-pointer flex-shrink-0">
        ...
        />
        <span className="flex h-14 min-w-[202px] items-center justify-center gap-2 rounded-[10px] bg-[#0052FF] px-5">
          <Image
          ...
          />
          <span className="whitespace-nowrap text-[16px] font-medium leading-6 text-white sm:text-[18px] sm:leading-[26px]">{buttonLabel}</span>
        </span>
      </label>
    </div>
  );
